...
## Assistant [2026-01-14T22:11:00.094Z]

```json
{
  "summary": "Performed a final polish pass on a blog post about CNC postprocessor debugging, focusing on a safety-critical bug where G0 rapid movement was incorrectly used instead of G1 controlled feed rate when plunging into material.",
  "key_topics": [
