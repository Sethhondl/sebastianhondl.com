...
## Assistant [2026-01-14T22:07:00.436Z]

```json
{
  "summary": "Performed a final polish pass on a blog post about CNC postprocessor debugging, focusing on a G-code bug that caused unsafe rapid plunges into material instead of controlled feed rates.",
  "key_topics": [
    "G-code debugging",
