...
## Assistant [2026-01-14T22:14:00.008Z]

```json
{
  "summary": "Performed a final polish pass on a blog post about CNC postprocessor debugging, focusing on a dangerous G-code bug that could cause tool crashes by using rapid movement instead of controlled plunge rates.",
  "key_topics": [
